...
export class AppComponent implements OnInit {
  ...
  onSubmit() {
    ...
    // this.http.post('http://interview-env.eba-ywb3pkxd.ap-south-1.elasticbeanstalk.com/api/interviews/sch', this.interviewForm.value).subscribe({
      this.http.post('http://localhost:8080/api/interviews/sch', this.interviewForm.value).subscribe({
        next: (response) => {
